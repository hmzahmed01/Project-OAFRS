...
<div class="sidebar">
  ...
  <div class="content">
    ...
    <table class="table">
        ...
        <tbody>
          <tr>
            <th scope="row">22345</th>
            <td>Air India</td>
            <td>Mon,Tue,Sat</td>
          </tr>
          <tr>
            <th scope="row">22346</th>
            <td>Emirates</td>
            <td>Friday</td>
          </tr>
          <tr>
            <th scope="row">22347</th>
            <td>Konoha flights</td>
            <td>Wed,Sun</td>
          </tr>
        </tbody>
      </table>
    ...
    <input type="text" class="form-control" id="AvailableDays" name="available_days">
  </div>
