...
<div class="sidebar">
  ...
  <div class="content">
    <p>
          <h3>FILL THE BELOW DETAILS TO RESERVE YOUR FLIGHT TICKET</h3>
      </p>
  ...
  <div class="mb-3">
    <label for="nos" class="form-label">No of seats</label>
    <input type="number" class="form-control" id="nos" name="NOS">
  </div>
  <div class="mb-3">
    <label for="reservatontype" class="form-label">Reservation Type</label>
    <input type="text" class="form-control" id="reservatontype" name="reservaton_type">
  </div>
