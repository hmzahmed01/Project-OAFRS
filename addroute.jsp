...
<div class="sidebar">
  ...
  <div class="content">
    ...
    <table class="table">
        ...
        <tbody>
          <tr>
            <th scope="row">25647</th>
            <td>NAT-A</td>
          </tr>
          <tr>
            <th scope="row">25467</th>
            <td>NAT-B</td>
          </tr>
          <tr>
            <th scope="row">38975</th>
            <td>NAT-c</td>
          </tr>
        </tbody>
      </table>
      ...
      <div class="collapse" id="collapseExample">
        <div class="card card-body">
          <form method="POST">
        <div class="mb-3">
        <label for="FlightID" class="form-label">Route ID</label>
        <input type="number" class="form-control" id="FlightID" name="flight_id">
      </div>
      <div class="mb-3">
        <label for="FlightName" class="form-label">Route Name</label>
  ...
  <button type="submit" class="btn btn-primary" name="sub">Submit</button>
    ...
    <div class="edit">
        <p>
      <a class="btn btn-primary" data-bs-toggle="collapseEdit" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseEditExample">
        Edit Route
      </a>
    </p>
    </div>
    <div class="delete">
    <p>
        <a class="btn btn-primary" data-bs-toggle="collapseDelete" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseDeleteExample">
          Delete Route
        </a>
    </p>
      </div>
